    ...
    <section v-if="recommandations.length">
      <div class="container mt-5 mb-3">
        ...
        <div class="pull-right">
          <a @click="scrollRight" class="widget--hover-brand-color pointer"><i class="fa fa-angle-left mr-4 w3-xxxlarge"></i></a>
          <a @click="scrollLeft" class="widget--hover-brand-color pointer"><i class="fa fa-angle-right w3-xxxlarge"></i></a>
        </div>
      </div>
